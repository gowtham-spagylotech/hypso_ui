...
//                 <div className={`${acceptMultipleFiles == false && featuredImage == true ? "border-dashed border border-solid border-gray-300 rounded-lg m-0 flex justify-center items-center h-260" : "border-dashed border border-solid border-gray-300 rounded-lg"}`} style={style}>
//                     {/* onclick to add file  */}
