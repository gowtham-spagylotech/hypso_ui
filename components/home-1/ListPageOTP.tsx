...
const ListPageOTP = ({ item }: any) => {
    ...
    if (!isCardOpen) {
        return null; // If the card is closed, don't render anything
    }
    ...
    return (
        <div key={id} className="bg-white rounded-2xl col-span-12 group ">
