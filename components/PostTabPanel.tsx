...
const PostTabPanel: React.FC<{ postData: PostData[] }> = ({ postData }) => {
    ...
    return (
        <div>
            ...
            {postData.map((recordData) => (
                
                <div key={recordData.service_id} className="tab-pane fade show active" id="upcoming">
                                ...
                                <div className="border border-neutral-40 p-4 p-sm-6 xl:p-8 rounded-2xl">
                                    <div className="flex flex-wrap items-center relative">
                                        ...
                                        <div className="flex-grow w-full lg:w-1/3 mt-4 lg:mt-0">
                                            <h5 className="font-medium">{recordData.name}</h5>
