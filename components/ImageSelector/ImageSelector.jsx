...
//                                     className="opacity-0 border-4 border-solid border-gray-300 h-350 w-350 p-0 m-0 left-4 top-29 cursor-pointer"
//                                     role="button"
...
//                     <div className="w-[60%]">
//                         <div className="w-[100%] flex justify-between items-center mt-5 border rounded p-1">
//                             <div className="w-[30%]">
...
//                                 <span type="button" name="search" id="search-btn" className="bg-gray-200 w-[40px] rounded-none rounded-r-md" onClick={() => onClickSearchBtn} >
...
//                         <div className="bg-gray-200 p-10 text-center border-none p-2">
//                             {/* {loading && <Loader className={"table_loader"} imageSelector={true} />} */}
//                             {!loading && (
//                                 <div className="flex col-lg-12 flex-wrap">
//                                     {images?.length == 0 ? (
//                                         <p className="flex justify-center items-center w-full h-30vh">Image Gallery is empty</p>
//                                     ) : (
//                                         <div className="flex col-lg-12 flex-wrap">
