  ...
  const createCategory = () => {
    fetch(`${apiUrl}/modules/categories/create`, {
      ...
      body: {
        ...
        "name": "products",
        "description": "new,used products",
        "featured_image": 1,
        "parent_category_id": 1,
        "entity_type": "ENT_LISTING",
        "is_active": true,
        "custom_field_settings": [{ "price": 5000 }, { "materials": "wood" }]
                    ...
                    {section?.fields?.map((field, index) => (
                      <div key={index} className={`w-[49%] relative`}>
                        {field.type == fieldTypeText && (
                          <div className={`${classNames.formFieldWrapper} relative`}>
                            {field.parent ?
                              <>
                                <div className="flex w-100 items-center justify-between">
                              ...
                              <>
                                ...
                                <div className="absolute right-0 top-28	cursor-pointer">
                                  <svg width="15px" height="15px" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
